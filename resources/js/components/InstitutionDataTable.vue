    ...
    methods: {
        ...
        processBulk() {
            ...
            if (this.bulkAction == 'Delete') {
                ...
                msg += "Activating these institutions will affect their COUNTER API credentials:<br>";
                ...
                msg += "Bulk processing will process each requested institution sequentially.<br><br>";
                msg += "De-Activating these institutions will affect their COUNTER API credentials:<br>";
